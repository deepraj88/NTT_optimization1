...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ntt.autotvin_q0.dat"
         "c.ntt.autotvin_q1.dat"
         "c.ntt.autotvin_q2.dat"
         "c.ntt.autotvin_q3.dat"
         "c.ntt.autotvin_q4.dat"
         "c.ntt.autotvin_q5.dat"
         "c.ntt.autotvin_q6.dat"
         "c.ntt.autotvin_q7.dat"
         "c.ntt.autotvin_zetas.dat"
         "c.ntt.autotvout_q0.dat"
         "c.ntt.autotvout_q1.dat"
         "c.ntt.autotvout_q2.dat"
         "c.ntt.autotvout_q3.dat"
         "c.ntt.autotvout_q4.dat"
         "c.ntt.autotvout_q5.dat"
         "c.ntt.autotvout_q6.dat"
         "c.ntt.autotvout_q7.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ntt.autotvout_q0.dat"
         "rtl.ntt.autotvout_q1.dat"
         "rtl.ntt.autotvout_q2.dat"
         "rtl.ntt.autotvout_q3.dat"
         "rtl.ntt.autotvout_q4.dat"
         "rtl.ntt.autotvout_q5.dat"
         "rtl.ntt.autotvout_q6.dat"
         "rtl.ntt.autotvout_q7.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
