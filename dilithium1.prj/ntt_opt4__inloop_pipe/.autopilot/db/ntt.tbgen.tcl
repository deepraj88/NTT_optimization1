...
set C_modelArgList {
	{ p int 32 regular {array 256 { 2 1 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	p { ap_memory {  { p_address0 mem_address 1 8 }  { p_ce0 mem_ce 1 1 }  { p_we0 mem_we 1 1 }  { p_d0 mem_din 1 32 }  { p_q0 mem_dout 0 32 }  { p_address1 MemPortADDR2 1 8 }  { p_ce1 MemPortCE2 1 1 }  { p_q1 MemPortDOUT2 0 32 } } }
}
