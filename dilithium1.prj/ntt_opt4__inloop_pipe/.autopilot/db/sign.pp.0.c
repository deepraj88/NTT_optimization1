...
# 11 "sign.c" 2
# 23 "sign.c"
void expand_mat(polyvecl mat[3], const unsigned char rho[32]) {_ssdm_SpecArrayDimSize(mat, 3);_ssdm_SpecArrayDimSize(rho, 32);
  unsigned int i, j;
...
# 98 "sign.c"
int crypto_sign_keypair(unsigned char pk[896U], unsigned char sk[2096U]) {_ssdm_SpecArrayDimSize(pk, 896);_ssdm_SpecArrayDimSize(sk, 2096);
  unsigned int i;
...
{_ssdm_SpecArrayDimSize(sm, 4787);_ssdm_SpecArrayDimSize(smlen, 1);_ssdm_SpecArrayDimSize(m, 3400);_ssdm_SpecArrayDimSize(sk, 2096);
...
{_ssdm_SpecArrayDimSize(m, 3400);_ssdm_SpecArrayDimSize(mlen, 1);_ssdm_SpecArrayDimSize(sm, 4787);_ssdm_SpecArrayDimSize(pk, 896);
  unsigned long long i;
