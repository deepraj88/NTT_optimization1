// ==============================================================
// File generated on Sat Dec 12 08:42:14 EST 2020
// Vivado(TM) HLS - High-Level Synthesis from C, C++ and SystemC v2018.3 (64-bit)
// SW Build 2405991 on Thu Dec  6 23:36:41 MST 2018
// IP Build 2404404 on Fri Dec  7 01:43:56 MST 2018
// Copyright 1986-2018 Xilinx, Inc. All Rights Reserved.
// ==============================================================
#1 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c"
#1 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c" 1
#1 "<built-in>" 1
#1 "<built-in>" 3
#149 "<built-in>" 3
#1 "<command line>" 1
#1 "<built-in>" 2
#1 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c" 2
...
#9 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c" 2
...
#10 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
#11 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c" 2
...
#12 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c" 2
#1 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/rng.h" 1
#18 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/rng.h"
typedef struct {
...
#13 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c" 2
...
#5 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/api.h" 2
...
#14 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c" 2
#37 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c"
...
#ifndef HLS_FASTSIM
#48 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c"
int
main()
{
    ...
    unsigned char m[3300], m1[3300], sm[3300+1387U], sm_rsp[3300+1387U];

    unsigned long long mlen, smlen, mlen1, smlen_rsp;
    int count;
    int done;
    unsigned char pk[896U], sk[2096U];
    int ret_val;
    ...
    FILE *fp_rsp;
    FILE *fp_init;
    unsigned char pk_rsp[896U], sk_rsp[2096U];
    ...
    sprintf(fn_init, "../../../../sign_init.data");

    if ( (fp_init = fopen(fn_init, "w")) == ((void*)0) ) {
    ...
    if ( (fp_rsp = fopen(fn_rsp, "r")) == ((void*)0) ) {
        printf("Couldn't open <%s> for read\n", fn_rsp);
        return -1;
    }
    ...
    do {
     ...
     if(count_loop == 1) {
        ...
        randombytes_init(seed, ((void*)0), 256);
        ...
        if ( !ReadHex(fp_rsp, pk_rsp, 896U, "pk = ") ) {
            printf("ERROR: unable to read 'pk' from <%s>\n", fn_rsp);
            return -3;
        }
        if ( !ReadHex(fp_rsp, sk_rsp, 2096U, "sk = ") ) {
            printf("ERROR: unable to read 'sk' from <%s>\n", fn_rsp);
            return -3;
        }


        if(memcmp(pk,pk_rsp,896U)!=0){
     printf("ERR: pk is different from <%s>\n", fn_rsp);

 }
#163 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c"
        if(memcmp(sk,sk_rsp,2096U)!=0){
     printf("ERROR: sk is different from <%s>\n", fn_rsp);

 }


        fprint_aes256_struct(fp_init);
...
#208 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c"
...
#endif
#253 "/home/dss545/vivado_hls/SHARING/CRYSTALS-Dilithium/Dilithium/Reference_Implementation/crypto_sign/project19/newtest_sign.c"
