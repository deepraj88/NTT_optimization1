...
`define AUTOTB_TVIN_p  "./c.ntt.autotvin_p.dat"
`define AUTOTB_TVIN_p_out_wrapc  "./rtl.ntt.autotvin_p.dat"
`define AUTOTB_TVOUT_p  "./c.ntt.autotvout_p.dat"
`define AUTOTB_TVOUT_p_out_wrapc  "./impl_rtl.ntt.autotvout_p.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 28;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_p = 256;
...
wire    [7 : 0]    arrayp_address0, arrayp_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.ntt.autotvout_p.dat", "r");
    fp2 = $fopen("./impl_rtl.ntt.autotvout_p.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.ntt.autotvout_p.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.ntt.autotvout_p.dat\"!");
    else begin
        $display("Comparing rtl.ntt.autotvout_p.dat with impl_rtl.ntt.autotvout_p.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
