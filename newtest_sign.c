/********************************************************************************************
* Abstract: run tests against known answer test vectors for DILITHIUM
*
...
#if defined(ONLY_KEYPAIR) && defined(ONLY_SIGN) && defined(ONLY_SIGN_OPEN)
    if ( (fp_init = fopen(fn_init, "w")) == NULL ) {
        printf("Couldn't open <%s> for read\n", fn_init);
        return KAT_FILE_OPEN_ERROR;
    }
#elif !defined(ONLY_KEYPAIR)
    if ( (fp_init = fopen(fn_init, "r")) == NULL ) {
        printf("Couldn't open <%s> for read\n", fn_init);
        return KAT_FILE_OPEN_ERROR;
    }
#endif
